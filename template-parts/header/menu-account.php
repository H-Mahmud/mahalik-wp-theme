...
<div show-header="" class="hydrated">
    <div class="s-user-menu-wrapper">
        <div class="s-user-menu-trigger-slot" onclick="window.location.href = '<?php echo wc_get_account_endpoint_url(''); ?>';" id="trigger-slot">
        ...
        <?php
        /*
        <div class="s-user-menu-toggler opened">
            <div class="s-user-menu-dropdown">
                <div class="s-user-menu-dropdown-header">
                    <img src="https://cdn.assets.salla.network/prod/stores/themes/default/assets/images/avatar_male.png" alt="Mahmudul Hasan">
                    <div class="s-user-menu-dropdown-header-content">
                        <span>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">Welcome</font>
                            </font>
                        </span>
                        <p>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">Mahmudul Hasan</font>
                            </font>
                        </p>
                    </div>
                ...
                <ul class="s-user-menu-dropdown-list">
                    <li class="s-user-menu-dropdown-item">
                        <a href="https://lamsah.co/ar/notifications">
                            <i>
                                <!-- Generated by IcoMoon.io -->
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                    ...
                    <li class="s-user-menu-dropdown-item">
                        <a href="https://lamsah.co/ar/orders">
                            <i>
                                <!-- Generated by IcoMoon.io -->
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                            ...
                            <span class="s-user-menu-dropdown-item-title">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Requests</font>
                                </font>
                            </span>
                        </a>
                    </li>
                    <li class="s-user-menu-dropdown-item">
                        <a href="https://lamsah.co/ar/pending_orders">
                            <i>
                                <!-- Generated by IcoMoon.io -->
                            ...
                            <span class="s-user-menu-dropdown-item-title">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Orders awaiting payment</font>
                                </font>
                            </span>
                        </a>
                    </li>
                    <li class="s-user-menu-dropdown-item">
                        <a href="https://lamsah.co/ar/wishlist">
                            <i>
                                <!-- Generated by IcoMoon.io -->
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                    <title>star</title>
                            ...
                            <span class="s-user-menu-dropdown-item-title">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Wishes</font>
                                </font>
                            </span>
                        </a>
                    </li>
                    <li class="s-user-menu-dropdown-item">
                        <a href="https://lamsah.co/ar/profile">
                            <i>
                                <!-- Generated by IcoMoon.io -->
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                            ...
                            <span class="s-user-menu-dropdown-item-title">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Arithmetic</font>
                                </font>
                            </span>
                        </a>
                    </li>
                    <li class="s-user-menu-dropdown-item s-user-menu-dropdown-item-logout">
                        <a href="https://lamsah.co/ar/logout">
                            <i>
                                <!-- Generated by IcoMoon.io -->
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                            ...
                            <span class="s-user-menu-dropdown-item-title">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">sign out</font>
                                </font>
                            </span>
                        </a>
                    </li>
