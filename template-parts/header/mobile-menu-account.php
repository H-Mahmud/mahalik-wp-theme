...
<div class="flex lg:hidden">
    <salla-user-menu class="mb-3 hydrated">
        <div class="s-user-menu-wrapper">
            <div class="s-user-menu-trigger-slot" id="trigger-slot">
                <div class="s-user-menu-trigger">
                    <div class="s-user-menu-avatar-wrap"><img class="s-user-menu-trigger-avatar" src="<?php echo get_theme_file_uri(); ?>/assets/images/avatar_male.webp" alt="<?php echo $user->display_name; ?>" /></div>
                    <div class="s-user-menu-trigger-content">
                        <span class="s-user-menu-trigger-hello"><?php _e('Welcome', 'mahalik'); ?></span>
                        <p class="s-user-menu-trigger-name"><?php echo $user->display_name; ?></p>
                    </div>
