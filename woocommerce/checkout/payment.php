...
<div class="row">
    <div class="col-md-12">
        <div id="payment" class="woocommerce-checkout-payment payment-step mb-0">

            <div data-step="2" class="title title--step">
                <img src="<?php echo get_theme_file_uri('assets/images/checkout/step-payment.svg'); ?>" />
                <h3><?php _e('propulsion', 'mahalik'); ?></h3>
            </div>

            <?php if (WC()->cart->needs_payment()) : ?>
                <div id="payment_methods_wrapper">
                    <ul class="wc_payment_methods payment_methods methods list list--payment-methods">
                        <?php
                        if (!empty($available_gateways)) {
                            foreach ($available_gateways as $gateway) {
                                wc_get_template('checkout/payment-method-list.php', array('gateway' => $gateway));
                            }
                        } else {
                            echo '<li>';
