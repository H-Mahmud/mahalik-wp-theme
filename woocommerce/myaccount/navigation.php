...
<nav class="shrink-0 lg:sticky top-24 lg:-mt-28 lg:border rounded lg:bg-white w-full lg:w-72 rtl:lg:ml-8 ltr:lg:mr-8 lg:pt-8 lg:pb-11 sidebar space-y-px">
    <div class="hidden lg:block">
        <ul class="s-user-menu-inline">
            <?php foreach (wc_get_account_menu_items() as $endpoint => $label) : ?>
                <li class="<?php echo wc_get_account_menu_item_classes($endpoint); ?> s-user-menu-dropdown-item">
