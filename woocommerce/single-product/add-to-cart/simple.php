...
if ($product->is_in_stock()) : ?>
    ...
    <form class="cart product-options form product-form flex flex-col space-y-2.5 sm:space-y-5" action="<?php echo esc_url(apply_filters('woocommerce_add_to_cart_form_action', $product->get_permalink())); ?>" method="post" enctype='multipart/form-data'>
            ...
            <div class="flex justify-between items-center">
                <div class="flex flex-col whitespace-nowrap rtl:space-x-reverse space-x-1">
                    <h4 class="total-price text-black font-bold text-xl inline-block">
                        <?php echo wc_price($product->get_price); // TODO: price for variable and discount product 
                        ?>
                    </h4>
                </div>
                <?php
